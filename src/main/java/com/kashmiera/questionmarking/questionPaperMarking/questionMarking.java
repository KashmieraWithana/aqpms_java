...
public class questionMarking {
    ...
    Connection con = null;
    static double similarityscorestring =0;
    ...
    public  String paperMarking(int paperId){
        ...
        try
        {
            ...
            for (studentAnswer s : stdAnsArray) {
                ...
                double sscore = semanticSimilarityScore;
                double cmark = (double)s.getContentMark();
                double product = sscore*cmark;
                double finalValue = Math.round(Double.parseDouble(format.format(product)));
                s.setScore((float)finalValue);
                String sql4 = "UPDATE structured_stud_answer SET contentMark = '"+ s.getScore()+"' WHERE structuredStudAnsId = '"+ s.getStudentAnswerId() +"' ";
                ...
                similarityscorestring = semanticSimilarityScore;
            }
        ...
        return "score: "+similarityscorestring;
    }
